...
//
  ...
  public DifferentialDriveWheelSpeeds getWheelSpeeds() {
        return new DifferentialDriveWheelSpeeds(m_frontLeftModule.getDriveVelocity(), m_frontRightModule.getDriveVelocity());   //idk this doesnt take into account back modules so try not to reak things
}
